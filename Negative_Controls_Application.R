...
for (I in 1:19) {
  ...
  for (J in 1:20) {
    ...
    mrlap_results <- try(MRlap(exposure =  exp_gwas, exposure_name = "Exp", outcome = out_gwas, outcome_name = "Out", MR_threshold = 5e-8, MR_pruning_LD = 0.001,
                               ld = "C:/Users/bj20642/OneDrive - University of Bristol/Desktop/MRC IEU Bristol/Negative Controls for Selection Bias/Schoeler_GWAS_Results/eur_w_ld_chr",
                               hm3 = "C:/Users/bj20642/OneDrive - University of Bristol/Desktop/MRC IEU Bristol/Negative Controls for Selection Bias/Schoeler_GWAS_Results/w_hm3.snplist"),
                         silent = TRUE)
